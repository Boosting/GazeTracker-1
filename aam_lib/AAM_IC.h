...
public:
	...
	// Fit the m_image using Inverse Compositional. 
	...
	// Draw the m_image according the searching result(0:point, 1:triangle, 2:appearance)
...
private:
	...
	// Calculating the modified steepest descent m_image.
	...
	// Compute the Hessian matrix using modified steepest descent m_image.
...
private:
	...
	CvMat*		__G;			/*Update matrix*/
						/*product of inverse Hessian with steepest descent m_image*/
...
private:
	...
	CvMat*		__warp_t;		/*warp m_image to base mesh*/
	CvMat*		__error_t;		/*error between warp m_image and template m_image A0*/
