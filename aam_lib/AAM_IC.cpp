				   ...
				   double texture_percentage /* = 0.975 */)
{
	...
	//calculate modified steepest descent m_image
	...
	//calculate update matrix (multiply inverse Hessian by modified steepest descent m_image)
				...
				int max_iter /* = 30 */, 	bool showprocess /* = false */)
{
	...
	for(int iter = 0; iter < max_iter; iter++)
	{
		...
		//warp m_image to mesh shape mesh
