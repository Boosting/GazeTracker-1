...
public:
	...
	// Warp the m_image to the mean shape mesh to calculate shape free patch
	void CalcWarpTexture(const CvMat* s, const IplImage* image,	CvMat* t)const;

	// For display, translate the texture vector to the visual-able m_image format
	// and then save into an m_image
